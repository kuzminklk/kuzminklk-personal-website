  ...
  return (
		<main className={styles.development}>
			...
			<section>
				...
				<p>
					I've built <Link href="https://kuzminklk.notion.site/31154d4de03580d7b5ceca5b187846be" target="blank">cool study structure in Notion<span className="emoji">📔</span></Link> which includes curriculum, study materials, workbooks, etc
				</p>
				<p>
					I develop web interfaces, applications, smart-contracts 
				</p>
				<p>
					You can explore my <Link href="https://github.com/kuzminklk" target="blank">GitHub<span className="emoji">👀</span></Link>
				</p>
			</section>
			<h2>🧰 Skills</h2>
			<section>
				<ul>
					...
					<li><i><strong>Additional:</strong> Design → Photos, Web-design, Drawing; Music → Guitar; Sports → Wrestling; Writing → Poetry, Philosophy essays</i></li>
				</ul>
			</section>
			<h1>💾 Projects</h1>
			<p>
				<i>All the projects you can explore in my <Link href="https://github.com/kuzminklk" target="blank">GitHub<span className="emoji">👀</span></Link>, here are the favorite ones!</i>
			</p>
			<section>
				<h2>💻 Web Interfaces</h2>
				<div className={styles.grid}>
					<section>
						<Link href="https://github.com/kuzminklk/erc-20" target="blank">
					...
					<section>
						<Link href="https://github.com/kuzminklk/buy-me-a-coffee" target="blank">
							<h3>Buy me a coffee!</h3>
						</Link>
						<p>Donation interface.  Fully works in Ethereum Sepolia</p>
						<Link href="https://buy-me-a-coffee-pixelated.vercel.app/" target="blank">
							<Image src={buyMeACoffee} placeholder="blur" alt="Buy me a coffe donation website screenshot"/>
						</Link>
					</section>
					<section>
						<Link href="https://github.com/kuzminklk/moby-dick" target="blank">
							<h3>Moby-Dick</h3>
						</Link>
						<p>Site, where you can read such an intresting book</p>
						<Link href="https://moby-dick-pi.vercel.app/" target="blank">
							<Image src={mobyDick} placeholder="blur" alt="Moby-Dick web-book screenshot"/>
						</Link>
					</section>
					<section>
						<Link href="https://github.com/kuzminklk/tsender" target="blank">
							<h3>Tsender</h3>
						</Link>
